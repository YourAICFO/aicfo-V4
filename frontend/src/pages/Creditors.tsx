...
export default function Creditors() {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h1 className="text-2xl font-semibold text-gray-900 dark:text-gray-100">Creditors</h1>
        <p className="text-sm text-slate-500 dark:text-slate-400">Payables intelligence based on monthly snapshots</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        <Card variant="subtle">
          <CardContent className="p-4 flex items-center gap-3">
            ...
            <div>
              <p className="text-sm text-slate-500 dark:text-slate-400">Total Creditors</p>
      ...
      <Card variant="default">
        <CardContent className="p-6">
          <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-4">Top 10 Creditors</h2>
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead>
                <tr className="border-b border-slate-200 dark:border-slate-600">
                  <th className="text-left py-3 px-4 font-medium text-slate-600 dark:text-slate-400">Creditor</th>
